...
En regardant les résidus, on peut voir de très nombreux pics, avec des valeurs extrêmes négatives qui peuvent s'expliquer par la fermeture les magasins de vente au détail et loisirs. Mais cela peut aussi s'expliquer par les fermetures à cause des jours fériés ou alors des dimanches.
