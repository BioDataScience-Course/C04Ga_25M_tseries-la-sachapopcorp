...
```{r}
#VOIR POUR LES DATES JE SUIS PAS SUR QUE L'ON PUISSE LES METTRE AINSI 

par(mfrow = c(3,2), mar = c(2,2,2,2))
retail_ts <- ts(feur$retail, start = c(2020, 2, 15), frequency = 365)
grocery_ts <- ts(feur$grocery,  start = c(2020, 2, 15), frequency = 365)
parks_ts <- ts(feur$parks,  start = c(2020, 2, 15), frequency = 365)
transit_ts <- ts(feur$transit,  start = c(2020, 2, 15), frequency = 365)
workplaces_ts <- ts(feur$workplaces,  start = c(2020, 2, 15), frequency = 365)
residential_ts <- ts(feur$residential,  start = c(2020, 2, 15), frequency = 365)
